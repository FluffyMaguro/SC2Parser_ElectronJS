...
from SC2Dictionaries import UnitNameDict, UnitAddKillsTo, UnitCompDict, UnitsInWaves, COMasteryUpgrades, HFTS_Units, TUS_Units, prestige_upgrades, amon_player_ids
...
def analyse_replay(filepath, main_player_handles=None):
    ...
    print(json.dumps(replay_report_dict))


if __name__ == "__main__":
    if len(sys.argv) > 1:
        file_path = sys.argv[1]
        analyse_replay(file_path)
    else:
